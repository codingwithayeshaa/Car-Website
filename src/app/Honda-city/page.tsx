...
export default function Home(){
    return(
        ...
        <div className="flex justify-center px-10 font-bold text-2xl my-6">
            ...
            <h1>Honda City 2024 Price In Pakistan,Images,Reviews 7 Specs</h1>
        </div>

        <div className="flex justify-center max-w-screen-2xl py-4">
            <img src="/Hondacity.jpg" alt="Honda-city"/>
        </div>
        ...
        <div className="flex justify-center">
            ...
            <p className="text-center font-semibold">Horsepower:88HP  Engine:1199 CC   Max.Speed:180 KM            
                Suspension Type:Soft Suspension  Avg:12-16 KM per liter  Transmission:Automatic  Fuel Type:Port Fuel Injection
                </p>
        </div>

        <div>
            <h1 className="text-center text-green-500 py-6">PKR 4,689,000</h1>
        </div>
